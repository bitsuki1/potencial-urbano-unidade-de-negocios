...
> **➡️ PRÓXIMA INSTÂNCIA (want-list M6, do Drive):** (a) **ingerir Lei 18.298/2025** — AUSENTE do corpus, a V.4.1 a cita como vigente (candidata nº1; capturar → `_entrada` → promover/fatiar/indexar); (b) reconciliar o corpus `leis/` com o corpus estruturado (medallion SILVER) do Drive p/ achar mais lacunas; (c) conferir rótulo Fi Art. 24 × Art. 25 LPUOS no verbatim. **Bloqueadas por dado/infra do dono:** T8/G1/G3/G4 (LOTES shapefiles · IPTU_2026 no Storage) · B-20/Fase-B (PII pesado Supabase) · B-8/B-9 (lane do Drive).
>
