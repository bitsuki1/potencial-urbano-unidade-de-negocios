...
> **➡️ PENDENTE (gate do MOU):** (a) revisar/ajustar qualquer das teses 02-05 (auto-escrutinadas, abertas a revisão); (b) **fiar `vtcd_na_data()`** nos 3.334 dossiês (toca nº do cliente); (c) decidir se o produto calcula o **lado receptor** (então liberam-se teses receptor-side); (d) capturar **inteiro teor** dos acórdãos (hoje fichas/metadados) — gancho de produto declarado; (e) **IPTU** é a próxima trilha (base inicial era TDC).
