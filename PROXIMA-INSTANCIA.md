...
> **➡️ PENDENTE (depende do MOU):** (a) **"pode mover"** para separar o `06 — Comercial` (as 43 bases) — MOVIMENTAÇÃO no Drive, com ensaio antes; (b) mover CRIADO+ILEGÍVEL→90, EXTERNO→06/apoio; (c) re-verificar os 10.673 OFICIAL contra a fonte (hash+verbatim+vigência) antes de ingerir no corpus `leis/`; (d) ingerir Lei 18.298/2025 (gap). READ-ONLY até o gate.
