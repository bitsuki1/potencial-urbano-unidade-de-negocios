...
> **PLACAR (após revisão do orquestrador):** OFICIAL 10.673 (32%) · ILEGÍVEL 12.845 (39%, 96% = PNG extraídos por nós) · CRIADO 7.272 (22%) · NÃO-OFICIAL-EXTERNO 2.348 (7%). **Revisão manual:** 4.162 "OFICIAL" eram fragmentos SILVER nossos → corrigidos p/ CRIADO; LOTES_*_IA confirmados CRIADO (D-DONO-4); Lei 18.298/2025 = gap a ingerir.
...
> **✅ 06 — COMERCIAL SEPARADO (MOU "pode mover" 2026-07-13):** pasta `06 — Comercial` criada (id `1V5XZm0I0S65wVM_wsXbzupipj_A3fYMd`), **43 bases movidas, 0 erros** (run 29245816119) — socios/empresas/iptu-2020/holdings/ITBI/extrato_ad/ZEPEC/Cartão CNPJ. Mover `scripts/mover_06_comercial_sa.py` + `arrumar-drive.yml` acao=comercial.
> **➡️ PENDENTE (depende de novo "pode" do MOU):** (a) mover CRIADO+ILEGÍVEL que ainda estejam FORA do `90` → `90` (a maior parte já foi na arrumação anterior; conferir os 4.162 fragmentos reclassificados + o que estiver em 02/03/05); (b) re-verificar os 10.673 OFICIAL contra a fonte (hash+verbatim+vigência) antes de ingerir no corpus `leis/`; (c) ingerir Lei 18.298/2025 (gap). READ-ONLY até o gate.
