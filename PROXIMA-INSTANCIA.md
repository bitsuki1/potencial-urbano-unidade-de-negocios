...
> **➡️ PENDENTE (depende de novo "pode" do MOU — é ESCRITA no corpus):** **ingerir da fila** (`FILA-INGESTAO-OFICIAL.csv`), começando por TDC + gap 18.298/2025, cada norma re-verificada verbatim+vigência+hash contra a fonte antes de virar `leis/` citável (1.6/1.7); + re-extrair os 49 HOLD ILEGÍVEL. READ-ONLY até o gate.
