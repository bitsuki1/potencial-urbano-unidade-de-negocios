...
5. **Divergência conhecida (~27%).** A estimativa de PCpt diverge dos m² das certidões reais (mediana da amostra ~1,27×). Onde há certidão, o **m² oficial vence a estimativa**.
