-- Reaplicação idempotente da 20260807103248 (mesmos 15 COMMENT ON TABLE) — registrada em
-- duplicidade no histórico do banco por nome diferente na mesma varredura #4; conteúdo idêntico.
